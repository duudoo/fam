...
const WeekDayCell = ({ day, events, isToday, onDayClick }: WeekDayCellProps) => {
  return (
    <div 
      className="min-h-[200px] flex flex-col rounded-md overflow-hidden border border-gray-200 shadow-sm hover:shadow-md transition-shadow cursor-pointer"
